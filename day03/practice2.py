...
number1 = int(input("정수입력1>"))
number2 = int(input("정수입력2>"))

if (number1+number2) >= 120 and number1>=50 and number2>50:
    print("합격")
else:
    print("불합격")    
...
player1 = int(input("가위바위보>"))
player2 = int(input("가위바위보>"))
